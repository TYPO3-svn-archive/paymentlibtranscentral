...
class tx_paymentlibipayment_provider_testcase extends PHPUnit2_Framework_TestCase {
	...
	public function test_getProviderObjectByPaymentMethod() {
		...
		$providerObject = $providerFactoryObj->getProviderObjectByPaymentMethod('paymentlib_ipayment_cc_visa');
		self::assertTrue (is_object($providerObject), "getProviderObjectByPaymentMethod ('paymentlib_ipayment_cc_visa') did not return ANY object!");
		self::assertEquals ($providerObject->getProviderKey(), $this->providerKey, "getProviderObjectByPaymentMethod ('paymentlib_ipayment_cc_visa') did not return the correct object!");
			
		$providerObject = $providerFactoryObj->getProviderObjectByPaymentMethod('paymentlib_ipayment_cc_mastercard');
		self::assertTrue (is_object($providerObject), "getProviderObjectByPaymentMethod ('paymentlib_ipayment_cc_mastercard') did not return ANY object!");
		self::assertEquals ($providerObject->getProviderKey(), $this->providerKey, "getProviderObjectByPaymentMethod ('paymentlib_ipayment_cc_masetercard') did not return the correct object!");

		$providerObject = $providerFactoryObj->getProviderObjectByPaymentMethod('paymentlib_ipayment_elv');
		self::assertTrue (is_object($providerObject), "getProviderObjectByPaymentMethod ('paymentlib_ipayment_elv') did not return ANY object!");
		self::assertEquals ($providerObject->getProviderKey(), $this->providerKey, "getProviderObjectByPaymentMethod ('paymentlib_ipayment_elv') did not return the correct object!");
	}
	...
	public function test_transaction_validate() {
		$providerObject = $this->getProviderObj();
					...
					// CHECKS FOR VISA:
		$providerObject->transaction_init (TX_PAYMENTLIB_TRANSACTION_ACTION_AUTHORIZEANDTRANSFER,'paymentlib_ipayment_cc_visa');
		...
		$providerObject->transaction_init (TX_PAYMENTLIB_TRANSACTION_ACTION_AUTHORIZEANDTRANSFER,'paymentlib_ipayment_cc_mastercard');
		...
		self::assertTrue(($result === FALSE), "advanced validation of Mastercard transaction should be negative but transaction_validate() did not return FALSE");
			...
			// CHECKS FOR ELV:
		$providerObject->transaction_init (TX_PAYMENTLIB_TRANSACTION_ACTION_AUTHORIZEANDTRANSFER,'paymentlib_ipayment_elv');
	...
	public function test_transaction_getResultsFromDB() {
		...
		$providerObject->transaction_init ($transactionType,'paymentlib_ipayment_cc_visa');
